...
namespace TransformarXmlEmCSharpESalvarNoBanco.Services.EvtPgtos
{
    public class EvtPgtosService
    {
        public ESocialEvtPgtos DesserializarEvtPgtos(string arquivo, string addNamespaceEvento, string addNamespaceRecibo)
        {
            string xmlContent;
            ...
            ESocialEvtPgtos resultado;
            using (StringReader stringReader = new StringReader(xmlContent))
            {
                XmlSerializer serializador = new XmlSerializer(typeof(ESocialEvtPgtos));
                resultado = (ESocialEvtPgtos)serializador.Deserialize(stringReader);
            }
            ...
            Console.WriteLine("XML de EvtPgtos desserializado em classes C#!");
            return resultado;
        }
    }
}