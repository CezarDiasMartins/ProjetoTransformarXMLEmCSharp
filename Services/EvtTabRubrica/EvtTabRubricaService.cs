...
namespace TransformarXmlEmCSharpESalvarNoBanco.Services.EvtTabRubrica
{
    public class EvtTabRubricaService
    {
        public ESocialEvtTabRubrica DesserializarEvtTabRubrica(string arquivo, string addNamespaceEvento, string addNamespaceRecibo)
        {
            string xmlContent;
            ...
            ESocialEvtTabRubrica resultado;
            using (StringReader stringReader = new StringReader(xmlContent))
            {
                XmlSerializer serializador = new XmlSerializer(typeof(ESocialEvtTabRubrica));
                resultado = (ESocialEvtTabRubrica)serializador.Deserialize(stringReader);
            }
            ...
            Console.WriteLine("XML de EvtTabRubrica desserializado em classes C#!");
            return resultado;
        }
    }
}