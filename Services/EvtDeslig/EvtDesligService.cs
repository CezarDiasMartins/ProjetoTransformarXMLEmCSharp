...
namespace TransformarXmlEmCSharpESalvarNoBanco.Services.EvtDeslig
{
    public class EvtDesligService
    {
        public ESocialEvtDeslig DesserializarEvtDeslig(string arquivo, string addNamespaceEvento, string addNamespaceRecibo)
        {
            string xmlContent;
            ...
            ESocialEvtDeslig resultado;
            using (StringReader stringReader = new StringReader(xmlContent))
            {
                XmlSerializer serializador = new XmlSerializer(typeof(ESocialEvtDeslig));
                resultado = (ESocialEvtDeslig)serializador.Deserialize(stringReader);
            }
            ...
            Console.WriteLine("XML de EvtDeslig desserializado em classes C#!");
            return resultado;
        }
    }
}